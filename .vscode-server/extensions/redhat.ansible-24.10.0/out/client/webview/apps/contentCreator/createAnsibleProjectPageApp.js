...
`,shadowOptions:{delegatesFocus:!0}}),Vn={vsCodeBadge:Gi,vsCodeButton:Ps,vsCodeCheckbox:Ms,vsCodeDataGrid:mo,vsCodeDataGridCell:Co,vsCodeDataGridRow:yo,vsCodeDivider:To,vsCodeDropdown:Go,vsCodeLink:Xo,vsCodeOption:Jo,vsCodePanels:nn,vsCodePanelTab:an,vsCodePanelView:dn,vsCodeProgressRing:un,vsCodeRadioGroup:gn,vsCodeRadio:Cn,vsCodeTag:wn,vsCodeTextArea:Pn,vsCodeTextField:Hn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}}}},t={};function i(s){var o=t[s];if(void 0!==o)return o.exports;var n=t[s]={exports:{}};return e[s](n,n.exports,i),n.exports}i.d=(e,t)=>{for(var s in t)i.o(t,s)&&!i.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var s={};(()=>{var e=s;Object.defineProperty(e,"B",{value:!0});const t=i(894);(0,t.provideVSCodeDesignSystem)().register(t.allComponents);const o=acquireVsCodeApi();let n,r,a,l,d,c,h,u,p,f,b,g,m,v,y,x,C,$,w,k,I;window.addEventListener("load",(function(){n=document.getElementById("path-url"),r=document.getElementById("folder-explorer"),a=document.getElementById("scm-org-name"),l=document.getElementById("scm-project-name"),h=document.getElementById("force-checkbox"),u=document.getElementById("log-to-file-checkbox"),u.addEventListener("change",R),p=document.getElementById("log-to-file-options-div"),f=document.getElementById("log-file-path"),b=document.getElementById("file-explorer"),g=document.getElementById("log-file-append-checkbox"),m=document.getElementById("log-level-dropdown"),v=document.getElementById("verbosity-dropdown"),d=document.getElementById("create-button"),c=document.getElementById("clear-button"),C=document.getElementById("log-text-area"),$=document.getElementById("clear-logs-button"),w=document.getElementById("open-log-file-button"),k=document.getElementById("copy-logs-button"),I=document.getElementById("open-folder-button"),n?.addEventListener("input",E),a?.addEventListener("input",E),l?.addEventListener("input",E),r.addEventListener("click",S),b.addEventListener("click",S),d?.addEventListener("click",D),d.disabled=!0,c?.addEventListener("click",A),$?.addEventListener("click",B),w?.addEventListener("click",P),k?.addEventListener("click",F),I?.addEventListener("click",L),y=document.getElementById("full-collection-path"),x=document.createElement("p"),x.innerHTML=n.placeholder,y?.appendChild(x)}));let T="",O="";function S(e){const t=e.target.parentNode.id;let i;i="folder-explorer"===t?"folder":"file",o.postMessage({command:"open-explorer",payload:{selectOption:i}}),window.addEventListener("message",(e=>{const i=e.data;if("file-uri"===i.command){const e=i.arguments.selectedUri;e&&("folder-explorer"===t?(n.value=e,x.innerHTML=e):f.value=e)}}))}function E(){n.value.trim()?x.innerHTML=n.value.trim():(x.innerHTML=`${n.placeholder}/${a.value.trim()}-${l.value.trim()}`,a.value.trim()&&l.value.trim()||(x.innerHTML=n.placeholder)),a.value.trim()&&l.value.trim()?d.disabled=!1:d.disabled=!0}function A(){n.value="",a.value="",l.value="",x.innerHTML=n.placeholder,h.checked=!1,v.currentValue="Off",d.disabled=!0,u.checked=!1,f.value="",g.checked=!1,m.currentValue="Debug"}function R(){u.checked?""!==p?.style.display&&"none"!==p?.style.display||(p.style.display="flex"):"flex"===p?.style.display&&(p.style.display="none")}function D(){d.disabled=!0,o.postMessage({command:"init-create",payload:{destinationPath:n.value.trim(),scmOrgName:a.value.trim(),scmProjectName:l.value.trim(),verbosity:v.currentValue.trim(),logToFile:u.checked,logFilePath:f.value.trim(),logFileAppend:g.checked,logLevel:m.currentValue.trim(),isForced:h.checked}}),window.addEventListener("message",(async e=>{const t=e.data;if("execution-log"===t.command)return C.value=t.arguments.commandOutput,T=t.arguments.logFileUrl,w.disabled=!T,t.arguments.status&&"passed"===t.arguments.status?I.disabled=!1:I.disabled=!0,O=t.arguments.projectUrl?t.arguments.projectUrl:"",void(d.disabled=!1)}))}function B(){C.value=""}function P(){o.postMessage({command:"init-open-log-file",payload:{logFileUrl:T}})}function F(){o.postMessage({command:"init-copy-logs",payload:{initExecutionLogs:C.value}})}function L(){o.postMessage({command:"init-open-scaffolded-folder",payload:{projectUrl:O}})}})();var o=s.B;export{o as __esModule};
