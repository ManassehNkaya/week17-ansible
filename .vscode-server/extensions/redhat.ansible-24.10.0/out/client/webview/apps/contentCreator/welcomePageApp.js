...
`}),$o={separator:"separator",presentation:"presentation"},wo={horizontal:"horizontal",vertical:"vertical"};class ko extends Ee{constructor(){super(...arguments),this.role=$o.separator,this.orientation=wo.horizontal}}M([B],ko.prototype,"role",void 0),M([B],ko.prototype,"orientation",void 0);class To extends ko{}const Io=To.compose({baseName:"divider",template:(e,t)=>Ft`
...
`,shadowOptions:{delegatesFocus:!0}});class Yo extends Eo{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}}const Jo=Yo.compose({baseName:"option",template:(e,t)=>Ft`
    <template
...
`}),kn={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class Tn extends Ee{}class In extends(gs(Tn)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const On={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class Sn extends In{constructor(){super(...arguments),this.type=On.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([B({attribute:"readonly",mode:"boolean"})],Sn.prototype,"readOnly",void 0),M([B({mode:"boolean"})],Sn.prototype,"autofocus",void 0),M([B],Sn.prototype,"placeholder",void 0),M([B],Sn.prototype,"type",void 0),M([B],Sn.prototype,"list",void 0),M([B({converter:D})],Sn.prototype,"maxlength",void 0),M([B({converter:D})],Sn.prototype,"minlength",void 0),M([B],Sn.prototype,"pattern",void 0),M([B({converter:D})],Sn.prototype,"size",void 0),M([B({mode:"boolean"})],Sn.prototype,"spellcheck",void 0),M([m],Sn.prototype,"defaultSlottedNodes",void 0);class An{}Zi(An,Ki),Zi(Sn,Xi,An);class Rn extends Ee{}class En extends(gs(Rn)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}class Dn extends En{constructor(){super(...arguments),this.resize=kn.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([B({mode:"boolean"})],Dn.prototype,"readOnly",void 0),M([B],Dn.prototype,"resize",void 0),M([B({mode:"boolean"})],Dn.prototype,"autofocus",void 0),M([B({attribute:"form"})],Dn.prototype,"formId",void 0),M([B],Dn.prototype,"list",void 0),M([B({converter:D})],Dn.prototype,"maxlength",void 0),M([B({converter:D})],Dn.prototype,"minlength",void 0),M([B],Dn.prototype,"name",void 0),M([B],Dn.prototype,"placeholder",void 0),M([B({converter:D,mode:"fromView"})],Dn.prototype,"cols",void 0),M([B({converter:D,mode:"fromView"})],Dn.prototype,"rows",void 0),M([B({mode:"boolean"})],Dn.prototype,"spellcheck",void 0),M([m],Dn.prototype,"defaultSlottedNodes",void 0),Zi(Dn,An);class Pn extends Dn{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Bn=Pn.compose({baseName:"text-area",template:(e,t)=>Ft`
    <template
        class="
...
`,shadowOptions:{delegatesFocus:!0}}),Vn={vsCodeBadge:Gi,vsCodeButton:Bs,vsCodeCheckbox:Ms,vsCodeDataGrid:vo,vsCodeDataGridCell:Co,vsCodeDataGridRow:yo,vsCodeDivider:Io,vsCodeDropdown:Go,vsCodeLink:Xo,vsCodeOption:Jo,vsCodePanels:nn,vsCodePanelTab:an,vsCodePanelView:dn,vsCodeProgressRing:un,vsCodeRadioGroup:gn,vsCodeRadio:Cn,vsCodeTag:wn,vsCodeTextArea:Bn,vsCodeTextField:Hn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}}}},t={};function i(s){var o=t[s];if(void 0!==o)return o.exports;var n=t[s]={exports:{}};return e[s](n,n.exports,i),n.exports}i.d=(e,t)=>{for(var s in t)i.o(t,s)&&!i.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var s={};(()=>{var e=s;Object.defineProperty(e,"B",{value:!0});const t=i(894);(0,t.provideVSCodeDesignSystem)().register(t.allComponents);const o=acquireVsCodeApi();let n,r,a,l,d,c,h,u,p,f,b,g;function v(){o.postMessage({message:"refresh-page"})}window.addEventListener("load",(function(){n=document.getElementById("system-readiness"),r=document.getElementById("system-check"),r&&(r.style.visibility="hidden"),a=document.getElementById("install-status"),l=document.createElement("section"),d=document.createElement("section"),c=document.createElement("section"),h=document.createElement("section"),u=document.createElement("section"),p=document.createElement("section"),b=document.createElement("section"),f=document.createElement("section"),g=document.getElementById("refresh"),g?.addEventListener("click",v),o.postMessage({message:"set-system-status-view"}),window.addEventListener("message",(e=>{const t=e.data;if("systemDetails"===t.command){const e=t.arguments,i=e["ansible version"],s=e["ansible location"],o=e["python version"],r=e["python location"],g=e["ansible-creator version"],v=e["ansible-dev-environment version"];i&&o&&g?(l.innerHTML='<span class="codicon codicon-pass"></span>',d.innerHTML='<p class="system-description"><b>All the tools are installed</b>.<br>Your environment is ready and you can start creating ansible content.</p>'):(l.innerHTML='<span class="codicon codicon-error"></span>',d.innerHTML="<p class=\"system-description\"><b>Looks like your environment is missing some tools</b>.<br>Follow the description in the 'System requirements' section to set up your environment.</p>"),n?.appendChild(l),n?.appendChild(d),c.innerHTML=i?`<p class='found'><b>Ansible version:</b> ${i}</p>`:"<p class='not-found'><b>Ansible version:</b> Not found</p>",a?.appendChild(c),h.innerHTML=s?`<p class='found'><b>Ansible location:</b> ${s}</p>`:"<p class='not-found'><b>Ansible location:</b> Not found</p>",a?.appendChild(h),u.innerHTML=o?`<p class='found'><b>Python version:</b> ${o}</p>`:"<p class='not-found'><b>Python version:</b> Not found</p>",a?.appendChild(u),p.innerHTML=r?`<p class='found'><b>Python location:</b> ${r}</p>`:"<p class='not-found'><b>Python location:</b> Not found</p>",a?.appendChild(p),b.innerHTML=v?`<p class='found'>[optional] <b>Ansible-dev-environment version:</b> ${v}</p>`:"<p class='not-found-optional'>[optional] <b>Ansible-dev-environment version:</b> Not found</p>",a?.appendChild(b),f.innerHTML=g?`<p class='found'><b>Ansible-creator version:</b> ${g}</p>`:'\n          <p class=\'not-found\'><b>Ansible-creator version:</b> Not found</p>\n          <br>\n          <p>Before getting started, please <vscode-link href="command:ansible.content-creator.install">install ansible-creator</vscode-link> (via pip) or <br>\n          <vscode-link href="command:ansible.python-settings.open">switch to a different python interpreter</vscode-link>  with ansible-creator already installed in it.</p>\n          ',a?.appendChild(f)}r&&(r.style.visibility="visible")}))}))})();var o=s.B;export{o as __esModule};
