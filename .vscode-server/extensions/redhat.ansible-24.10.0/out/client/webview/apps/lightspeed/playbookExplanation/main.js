...
`});Object.create,Object.create,"function"==typeof SuppressedError&&SuppressedError;class Ki{}N([L({attribute:"aria-atomic"})],Ki.prototype,"ariaAtomic",void 0),N([L({attribute:"aria-busy"})],Ki.prototype,"ariaBusy",void 0),N([L({attribute:"aria-controls"})],Ki.prototype,"ariaControls",void 0),N([L({attribute:"aria-current"})],Ki.prototype,"ariaCurrent",void 0),N([L({attribute:"aria-describedby"})],Ki.prototype,"ariaDescribedby",void 0),N([L({attribute:"aria-details"})],Ki.prototype,"ariaDetails",void 0),N([L({attribute:"aria-disabled"})],Ki.prototype,"ariaDisabled",void 0),N([L({attribute:"aria-errormessage"})],Ki.prototype,"ariaErrormessage",void 0),N([L({attribute:"aria-flowto"})],Ki.prototype,"ariaFlowto",void 0),N([L({attribute:"aria-haspopup"})],Ki.prototype,"ariaHaspopup",void 0),N([L({attribute:"aria-hidden"})],Ki.prototype,"ariaHidden",void 0),N([L({attribute:"aria-invalid"})],Ki.prototype,"ariaInvalid",void 0),N([L({attribute:"aria-keyshortcuts"})],Ki.prototype,"ariaKeyshortcuts",void 0),N([L({attribute:"aria-label"})],Ki.prototype,"ariaLabel",void 0),N([L({attribute:"aria-labelledby"})],Ki.prototype,"ariaLabelledby",void 0),N([L({attribute:"aria-live"})],Ki.prototype,"ariaLive",void 0),N([L({attribute:"aria-owns"})],Ki.prototype,"ariaOwns",void 0),N([L({attribute:"aria-relevant"})],Ki.prototype,"ariaRelevant",void 0),N([L({attribute:"aria-roledescription"})],Ki.prototype,"ariaRoledescription",void 0);class Wi{constructor(e,t){this.target=e,this.propertyName=t}bind(e){e[this.propertyName]=this.target}unbind(){}}function Qi(e){return new ht("fast-ref",Wi,e)}class Xi{handleStartContentChange(){this.startContainer.classList.toggle("start",this.start.assignedNodes().length>0)}handleEndContentChange(){this.endContainer.classList.toggle("end",this.end.assignedNodes().length>0)}}const Yi=(e,t)=>_t`
    <span
        part="end"
        ${Qi("endContainer")}
...
`;function Zi(e,...t){const i=A.locate(e);t.forEach((t=>{Object.getOwnPropertyNames(t.prototype).forEach((i=>{"constructor"!==i&&Object.defineProperty(e.prototype,i,Object.getOwnPropertyDescriptor(t.prototype,i))})),A.locate(t).forEach((e=>i.push(e)))}))}var es;_t`
...
`,styles:(e,t)=>Bt`
	...
	${Ds}
	${Rs}
`,shadowOptions:{delegatesFocus:!0}});class _s extends De{}class Hs extends(vs(_s)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}class Bs extends Hs{constructor(){super(),this.initialValue="on",this.indeterminate=!1,this.keypressHandler=e=>{this.readOnly||e.key!==ds||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.clickHandler=e=>{this.disabled||this.readOnly||(this.indeterminate&&(this.indeterminate=!1),this.checked=!this.checked)},this.proxy.setAttribute("type","checkbox")}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly)}}N([L({attribute:"readonly",mode:"boolean"})],Bs.prototype,"readOnly",void 0),N([m],Bs.prototype,"defaultSlottedNodes",void 0),N([m],Bs.prototype,"indeterminate",void 0);class Fs extends Bs{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Checkbox")}}const Ns=Fs.compose({baseName:"checkbox",template:(e,t)=>_t`
    <template
        role="checkbox"
...
`;class bo extends De{constructor(){super(...arguments),this.cellType=Vs.default,this.rowData=null,this.columnDefinition=null,this.isActiveCell=!1,this.customCellView=null,this.updateCellStyle=()=>{this.style.gridColumn=this.gridColumn}}cellTypeChanged(){this.$fastController.isConnected&&this.updateCellView()}gridColumnChanged(){this.$fastController.isConnected&&this.updateCellStyle()}columnDefinitionChanged(e,t){this.$fastController.isConnected&&this.updateCellView()}connectedCallback(){var e;super.connectedCallback(),this.addEventListener(no,this.handleFocusin),this.addEventListener(ro,this.handleFocusout),this.addEventListener(ao,this.handleKeydown),this.style.gridColumn=`${void 0===(null===(e=this.columnDefinition)||void 0===e?void 0:e.gridColumn)?0:this.columnDefinition.gridColumn}`,this.updateCellView(),this.updateCellStyle()}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(no,this.handleFocusin),this.removeEventListener(ro,this.handleFocusout),this.removeEventListener(ao,this.handleKeydown),this.disconnectCellView()}handleFocusin(e){if(!this.isActiveCell){if(this.isActiveCell=!0,this.cellType===Vs.columnHeader){if(null!==this.columnDefinition&&!0!==this.columnDefinition.headerCellInternalFocusQueue&&"function"==typeof this.columnDefinition.headerCellFocusTargetCallback){const e=this.columnDefinition.headerCellFocusTargetCallback(this);null!==e&&e.focus()}}else if(null!==this.columnDefinition&&!0!==this.columnDefinition.cellInternalFocusQueue&&"function"==typeof this.columnDefinition.cellFocusTargetCallback){const e=this.columnDefinition.cellFocusTargetCallback(this);null!==e&&e.focus()}this.$emit("cell-focused",this)}}handleFocusout(e){this===document.activeElement||this.contains(document.activeElement)||(this.isActiveCell=!1)}handleKeydown(e){if(!(e.defaultPrevented||null===this.columnDefinition||this.cellType===Vs.default&&!0!==this.columnDefinition.cellInternalFocusQueue||this.cellType===Vs.columnHeader&&!0!==this.columnDefinition.headerCellInternalFocusQueue))switch(e.key){case ns:case"F2":if(this.contains(document.activeElement)&&document.activeElement!==this)return;if(this.cellType===Vs.columnHeader){if(void 0!==this.columnDefinition.headerCellFocusTargetCallback){const t=this.columnDefinition.headerCellFocusTargetCallback(this);null!==t&&t.focus(),e.preventDefault()}}else if(void 0!==this.columnDefinition.cellFocusTargetCallback){const t=this.columnDefinition.cellFocusTargetCallback(this);null!==t&&t.focus(),e.preventDefault()}break;case rs:this.contains(document.activeElement)&&document.activeElement!==this&&(this.focus(),e.preventDefault())}}updateCellView(){if(this.disconnectCellView(),null!==this.columnDefinition)switch(this.cellType){case Vs.columnHeader:void 0!==this.columnDefinition.headerCellTemplate?this.customCellView=this.columnDefinition.headerCellTemplate.render(this,this):this.customCellView=fo.render(this,this);break;case void 0:case Vs.rowHeader:case Vs.default:void 0!==this.columnDefinition.cellTemplate?this.customCellView=this.columnDefinition.cellTemplate.render(this,this):this.customCellView=po.render(this,this)}}disconnectCellView(){null!==this.customCellView&&(this.customCellView.dispose(),this.customCellView=null)}}N([L({attribute:"cell-type"})],bo.prototype,"cellType",void 0),N([L({attribute:"grid-column"})],bo.prototype,"gridColumn",void 0),N([m],bo.prototype,"rowData",void 0),N([m],bo.prototype,"columnDefinition",void 0);class go extends lo{connectedCallback(){super.connectedCallback(),this.getAttribute("aria-label")||this.setAttribute("aria-label","Data Grid")}}const vo=go.compose({baseName:"data-grid",baseClass:lo,template:(e,t)=>{const i=function(e){const t=e.tagFor(uo);return _t`
    <${t}
        :rowData="${e=>e}"
        :cellItemTemplate="${(e,t)=>t.parent.cellItemTemplate}"
        :headerCellItemTemplate="${(e,t)=>t.parent.headerCellItemTemplate}"
    ></${t}>
`}(e),s=e.tagFor(uo);return _t`
        <template
            role="grid"
            tabindex="0"
            :rowElementTag="${()=>s}"
...
`});class mo extends uo{}const yo=mo.compose({baseName:"data-grid-row",baseClass:uo,template:(e,t)=>{const i=function(e){const t=e.tagFor(bo);return _t`
    <${t}
    ...
    ></${t}>
`}(e),s=function(e){const t=e.tagFor(bo);return _t`
    <${t}
...
`});class xo extends bo{}const Co=xo.compose({baseName:"data-grid-cell",baseClass:bo,template:(e,t)=>_t`
        <template
            tabindex="-1"
...
`,indicator:'\n\t\t<svg \n\t\t\tclass="select-indicator"\n\t\t\tpart="select-indicator"\n\t\t\twidth="16" \n\t\t\theight="16" \n\t\t\tviewBox="0 0 16 16" \n\t\t\txmlns="http://www.w3.org/2000/svg" \n\t\t\tfill="currentColor"\n\t\t>\n\t\t\t<path \n\t\t\t\tfill-rule="evenodd" \n\t\t\t\tclip-rule="evenodd" \n\t\t\t\td="M7.976 10.072l4.357-4.357.62.618L8.284 11h-.618L3 6.333l.619-.618 4.357 4.357z"\n\t\t\t/>\n\t\t</svg>\n\t'});class Ko extends De{constructor(){super(...arguments),this.handleUnsupportedDelegatesFocus=()=>{var e;window.ShadowRoot&&!window.ShadowRoot.prototype.hasOwnProperty("delegatesFocus")&&(null===(e=this.$fastController.definition.shadowOptions)||void 0===e?void 0:e.delegatesFocus)&&(this.focus=()=>{var e;null===(e=this.control)||void 0===e||e.focus()})}}connectedCallback(){super.connectedCallback(),this.handleUnsupportedDelegatesFocus()}}N([L],Ko.prototype,"download",void 0),N([L],Ko.prototype,"href",void 0),N([L],Ko.prototype,"hreflang",void 0),N([L],Ko.prototype,"ping",void 0),N([L],Ko.prototype,"referrerpolicy",void 0),N([L],Ko.prototype,"rel",void 0),N([L],Ko.prototype,"target",void 0),N([L],Ko.prototype,"type",void 0),N([m],Ko.prototype,"defaultSlottedContent",void 0);class Wo{}N([L({attribute:"aria-expanded"})],Wo.prototype,"ariaExpanded",void 0),Zi(Wo,Ki),Zi(Ko,Xi,Wo);class Qo extends Ko{}const Xo=Qo.compose({baseName:"link",template:(e,t)=>_t`
    <a
        class="control"
        part="control"
...
`,shadowOptions:{delegatesFocus:!0}});class Yo extends Do{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}}const Jo=Yo.compose({baseName:"option",template:(e,t)=>_t`
    <template
...
`});class rn extends tn{connectedCallback(){super.connectedCallback(),this.disabled&&(this.disabled=!1),this.textContent&&this.setAttribute("aria-label",this.textContent)}}const an=rn.compose({baseName:"panel-tab",template:(e,t)=>_t`
...
`});class ln extends sn{}const dn=ln.compose({baseName:"panel-view",template:(e,t)=>_t`
...
`});class cn extends De{constructor(){super(...arguments),this.percentComplete=0}valueChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}minChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}maxChanged(){this.$fastController.isConnected&&this.updatePercentComplete()}connectedCallback(){super.connectedCallback(),this.updatePercentComplete()}updatePercentComplete(){const e="number"==typeof this.min?this.min:0,t="number"==typeof this.max?this.max:100,i="number"==typeof this.value?this.value:0,s=t-e;this.percentComplete=0===s?0:Math.fround((i-e)/s*100)}}N([L({converter:R})],cn.prototype,"value",void 0),N([L({converter:R})],cn.prototype,"min",void 0),N([L({converter:R})],cn.prototype,"max",void 0),N([L({mode:"boolean"})],cn.prototype,"paused",void 0),N([m],cn.prototype,"percentComplete",void 0);class hn extends cn{connectedCallback(){super.connectedCallback(),this.paused&&(this.paused=!1),this.setAttribute("aria-label","Loading"),this.setAttribute("aria-live","assertive"),this.setAttribute("role","alert")}attributeChangedCallback(e,t,i){"value"===e&&this.removeAttribute("value")}}const un=hn.compose({baseName:"progress-ring",template:(e,t)=>_t`
    <template
        role="progressbar"
...
`,checkedIndicator:'\n\t\t<div part="checked-indicator" class="checked-indicator"></div>\n\t'});class $n extends lt{connectedCallback(){super.connectedCallback(),this.circular&&(this.circular=!1)}}const wn=$n.compose({baseName:"tag",template:Ht,styles:(e,t)=>Bt`
	${Ft("inline-block")} :host {
		box-sizing: border-box;
		font-family: ${Yt};
		font-size: ${si};
...
`}),kn={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class Tn extends De{}class In extends(gs(Tn)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const En={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class Sn extends In{constructor(){super(...arguments),this.type=En.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}N([L({attribute:"readonly",mode:"boolean"})],Sn.prototype,"readOnly",void 0),N([L({mode:"boolean"})],Sn.prototype,"autofocus",void 0),N([L],Sn.prototype,"placeholder",void 0),N([L],Sn.prototype,"type",void 0),N([L],Sn.prototype,"list",void 0),N([L({converter:R})],Sn.prototype,"maxlength",void 0),N([L({converter:R})],Sn.prototype,"minlength",void 0),N([L],Sn.prototype,"pattern",void 0),N([L({converter:R})],Sn.prototype,"size",void 0),N([L({mode:"boolean"})],Sn.prototype,"spellcheck",void 0),N([m],Sn.prototype,"defaultSlottedNodes",void 0);class On{}Zi(On,Ki),Zi(Sn,Xi,On);class An extends De{}class Dn extends(gs(An)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}class Rn extends Dn{constructor(){super(...arguments),this.resize=kn.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}N([L({mode:"boolean"})],Rn.prototype,"readOnly",void 0),N([L],Rn.prototype,"resize",void 0),N([L({mode:"boolean"})],Rn.prototype,"autofocus",void 0),N([L({attribute:"form"})],Rn.prototype,"formId",void 0),N([L],Rn.prototype,"list",void 0),N([L({converter:R})],Rn.prototype,"maxlength",void 0),N([L({converter:R})],Rn.prototype,"minlength",void 0),N([L],Rn.prototype,"name",void 0),N([L],Rn.prototype,"placeholder",void 0),N([L({converter:R,mode:"fromView"})],Rn.prototype,"cols",void 0),N([L({converter:R,mode:"fromView"})],Rn.prototype,"rows",void 0),N([L({mode:"boolean"})],Rn.prototype,"spellcheck",void 0),N([m],Rn.prototype,"defaultSlottedNodes",void 0),Zi(Rn,On);class Pn extends Rn{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Ln=Pn.compose({baseName:"text-area",template:(e,t)=>_t`
    <template
        class="
...
`,shadowOptions:{delegatesFocus:!0}});function _n(e,t,i){return e.nodeType!==Node.TEXT_NODE||"string"==typeof e.nodeValue&&!!e.nodeValue.trim().length}class Hn extends Sn{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text field")}}const Bn=Hn.compose({baseName:"text-field",template:(e,t)=>_t`
    <template
        class="
            ${e=>e.readOnly?"readonly":""}
        "
    >
        ...
        >
            <slot
                ${Ts({property:"defaultSlottedNodes",filter:_n})}
            ></slot>
        </label>
...
`,shadowOptions:{delegatesFocus:!0}}),Fn={vsCodeBadge:qi,vsCodeButton:Ls,vsCodeCheckbox:Ns,vsCodeDataGrid:vo,vsCodeDataGridCell:Co,vsCodeDataGridRow:yo,vsCodeDivider:Io,vsCodeDropdown:qo,vsCodeLink:Xo,vsCodeOption:Jo,vsCodePanels:nn,vsCodePanelTab:an,vsCodePanelView:dn,vsCodeProgressRing:un,vsCodeRadioGroup:gn,vsCodeRadio:Cn,vsCodeTag:wn,vsCodeTextArea:Ln,vsCodeTextField:Bn,register(e,...t){if(e)for(const i in this)"register"!==i&&this[i]().register(e,...t)}}}},t={};function i(s){var o=t[s];if(void 0!==o)return o.exports;var n=t[s]={exports:{}};return e[s](n,n.exports,i),n.exports}i.d=(e,t)=>{for(var s in t)i.o(t,s)&&!i.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var s={};(()=>{var e=s;Object.defineProperty(e,"B",{value:!0});const t=i(894),o=i(61);(0,t.provideVSCodeDesignSystem)().register((0,t.vsCodeButton)());const n=acquireVsCodeApi();function r(e,t){const i=document.getElementById(e);i&&i.addEventListener("click",(()=>t()))}function a(){const e=document.getElementById("thumbsup-button"),t=document.getElementById("thumbsdown-button");e.setAttribute("class","iconButtonSelected"),t.setAttribute("class","iconButton"),n.postMessage({command:"thumbsUp",action:o.ThumbsUpDownAction.UP})}function l(){const e=document.getElementById("thumbsup-button"),t=document.getElementById("thumbsdown-button");e.setAttribute("class","iconButton"),t.setAttribute("class","iconButtonSelected"),n.postMessage({command:"thumbsDown",action:o.ThumbsUpDownAction.DOWN})}window.addEventListener("load",(function(){r("thumbsup-button",a),r("thumbsdown-button",l),function(e,t){const i=document.getElementsByClassName("feedbackContainer");for(let e=0;e<i.length;e++)i[e].style.display="flex"}()}))})();var o=s.B;export{o as __esModule};
